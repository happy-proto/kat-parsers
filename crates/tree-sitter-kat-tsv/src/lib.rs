...
pub const LANGUAGE: LanguageFn = unsafe { LanguageFn::from_raw(tree_sitter_tsv) };
pub const GRAMMAR: &str = include_str!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/vendor/tsv/grammar.json"
));
pub const NODE_TYPES: &str = include_str!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/vendor/tsv/node-types.json"
));
...
mod tests {
    ...
    fn can_load_language() {
        ...
        parser
            ...
            .expect("failed to load tsv parser");
