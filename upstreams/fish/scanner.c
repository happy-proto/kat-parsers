...
void tree_sitter_fish_external_scanner_destroy(void *p) { (void)p; }
void tree_sitter_fish_external_scanner_reset(void *p) { (void)p; }
unsigned tree_sitter_fish_external_scanner_serialize(void *p, char *buffer) {
    (void)p;
    (void)buffer;
    return 0;
}
